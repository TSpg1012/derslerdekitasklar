...
// let addedname=prompt("enter the name")
// arr.forEach((element) => {
//   if (element?.name?.toUpperCase().trim().includes(addedname.toUpperCase().trim())){
//     console.log(element);
//   }
// })

// arr.filter(function (elem){
//   if ( elem.discontinued==true){
//     console.log(elem)
//   }
// })

// arr.filter(function (elem){
//     if ( elem.unitPrice>22){
//       console.log(elem)
//     }
//   })

// arr.filter(function (elem){
//       if ( elem.supplier?.address.country == "Spain"){
//         console.log(elem)
//       }
//     })
...
// let power = prompt("enter the power of number")
// console.log(Math.floor(num)**power)
// console.log(Math.sqrt(Math.floor(num)))



// const d = new Date()
// console.log(d.getFullYear(),d.getMonth()+1,d.getDay(),d.getDate(),d.getHours(),d.getMinutes(),d.getSeconds())
...
// console.log(product.every((element) => element.isDiscounted==true))
// console.log(product.some((element) => element.name=="sprite"))